...
if($adsoyad==""||$yorum==""){ echo '<div class="error msg" style="width:300px;"><b>Alanları boş geçemezsiniz!</b></div><br>'; }else{

$db->query("UPDATE comments SET adsoyad='$adsoyad',yorum='$yorum',onay='$onay' where id='$id'");

echo "<div class='done msg' style='width:200px;'><b>Düzenleme Kaydedildi!</b></div><br>";
echo '<meta http-equiv="refresh" content="2">'; } }

foreach($db->query("select * from comments where id='$id'") as $gelen){ ?>
						<form method="post">

		<b>Yorumun Gönderildiği Yazı :</b> <?php foreach($db->query("select * from blog where id='".$gelen['blogID']."'") as $aaa){ echo $aaa['title']; } ?> <br><br> 						
			<div class="col50">
		...
		<p class="t-justify">   
						...
						<input type="text" size="40" readonly value="<?php echo $gelen['email']; ?>" class="input-text" /><br><br>
						...
						<?php if($gelen['onay']=="1"){ ?>
						<input type="radio" name="onay" value="1" checked> <img src="design/ico-done.gif" /> &nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="onay" value="0"> <img src="design/ico-delete.gif" /><br><br>
						<?php }elseif($gelen['onay']=="0"){ ?>
						<input type="radio" name="onay" value="1"> <img src="design/ico-done.gif" /> &nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="onay" value="0" checked> <img src="design/ico-delete.gif" /><br><br>						
						<?php } ?>								
			...
			<div class="col50 f-right">
				...
				<p class="t-justify">
						...
						<textarea cols="75" rows="20" name="yorum" class="input-text"><?php echo $gelen['yorum']; ?></textarea><br><br>								
