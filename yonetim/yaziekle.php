...
if($title==""||$content==""||$resimyolu==""||$keywords==""||$description==""){ echo '<div class="error msg" style="width:300px;"><b>Bütün alanları doldurmanız gerekmektedir.</b></div>'; }else{

$kayit = $db->prepare("insert into blog set title=?,content=?,resimyolu=?,tarih=?,keywords=?,description=?,sefurl=?");
$kayit->execute(array($title, $content, $resimyolu, $tarih, $keywords, $description, $url)); 

 echo "<div class='done msg' style='width:200px;'><b>Yazı Eklendi!</b></div>"; echo '<meta http-equiv="refresh" content="2">'; } } ?>
		...
		<p class="t-justify">   
						...
						<input type="text" size="100" name="title" class="input-text" /><br><br>
					
						<label><b>Resim</b> (150 x 100)</label><br>
						...
						<label><b>Anahtar Kelimeler (Etiket)</b></label><br>
						<textarea cols="75" rows="2" name="keywords" class="input-text"></textarea><br><br>	

						<label><b>Sayfa Tanımlama (Cümle, kelime)</b></label><br>
						<textarea cols="75" rows="2" name="description" class="input-text"></textarea><br><br>							
