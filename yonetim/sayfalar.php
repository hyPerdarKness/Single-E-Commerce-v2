...
<div id="main">
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
			...
			<h1>Sayfalar</h1>
			<br><br>
<?php if(isset($_GET['sil'])){ $sil = intval($_GET['sil']); $db->query("delete from pages where id='$sil'"); 
...
<?php foreach($db->query("select * from pages order by id desc") as $gelen){ $id = $gelen['id']; ?>					
			<?php if ($id%2!=0){ echo '<tr>'; }else{ echo '<tr class="bg">'; } ?>	
				    <td align="center" style="width:100px;"><?php echo $gelen['sira']; ?></td>
				    <td style="width:1000px;"><?php echo $gelen['title']; ?></td>
				    <td style="width:100px;" align="center"><a href="pagedit.php?id=<?php echo $gelen['id']; ?>"><img src="design/edit.png" alt="" title="Düzenle" /></a> &nbsp;&nbsp; <a href="sayfalar.php?sil=<?php echo $gelen['id']; ?>"><img src="design/cross.png" alt="" title="Sil" /></a></td>
				</tr>
			<?php } ?>
			</table>
			<br>
			<p class="info msg"><b>Sıra No site menülerde ki sıralamayı(1,2,3...) sağlamaktadır. Lütfen ekleme veya düzenleme yaparken bunu göz önünde bulundurun.</b></p>
