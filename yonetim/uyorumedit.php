...
$db->query("UPDATE yorumlar SET adsoyad='$adsoyad',yorum='$yorum',onay='$onay' where id='$id'");

 echo "<div class='done msg' style='width:200px;'><b>Düzenleme Kaydedildi!</b></div><br>";
 echo '<meta http-equiv="refresh" content="2">'; } }

foreach($db->query("select * from yorumlar where id='$id'") as $gelen){ ?>
						<form method="post">
			<div class="col50">
		...
		<p class="t-justify">   
						...
						<input type="text" readonly size="40" value="<?php echo $gelen['ip']; ?>" class="input-text" /><br><br>	
