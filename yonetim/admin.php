...
if($username==""||$password==""){ echo '<div class="error msg" style="width:300px;"><b>Bir hata oluştu. Lütfen yeniden deneyiniz.</b></div>'; }else{
...
echo '<div class="warning msg" style="width:700px;">
 ...
 echo "<br><div class='done msg' style='width:200px;'><b>Düzenleme Kaydedildi!</b></div>"; echo '<meta http-equiv="refresh" content="5">'; } } ?><br><br>
						<form method="post">
						<label><b>Kullanıcı Adı</b></label><br>
						<input type="text" size="40" name="username" value="<?php echo $_SESSION['tekurun']; ?>" class="input-text" /><br><br>
					
						<label><b>Şifre</b></label><br>
						<input type="text" size="40" name="password" class="input-text" /><br><br>

						<input type="submit" class="input-submit" name="gonder" value="Değişiklikleri Kaydet" />
						</form>
			<br><br>
		</div>
