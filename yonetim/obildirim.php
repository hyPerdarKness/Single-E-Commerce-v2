...
<div id="main">
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
			...
			<br><br>
<?php if(isset($_GET['sil'])){ $sil = intval($_GET['sil']); $db->query("delete from odemebildirimi where id='$sil'"); 
echo "<div class='warning msg' style='width:200px;'><b>Bildirim silindi.</b></div><br>"; echo '<meta http-equiv="refresh" content="2;URL=obildirim.php">'; } ?>			
			<table>
				<tr>
				    <th>Ad Soyad</th>
				    <th>E-Mail</th>
...
<?php  foreach($db->query("select * from odemebildirimi order by id desc") as $gelen){ $id = $gelen['id']; ?>					
			<?php if ($id%2!=0){ echo '<tr>'; }else{ echo '<tr class="bg">'; } ?>	
				    ...
				    <td style="width:100px;" align="center"><a href="obildirimview.php?id=<?php echo $gelen['id']; ?>"><img src="design/views-icon.png" alt="" title="Ayrıntılar" /></a> &nbsp;&nbsp; <a href="obildirim.php?sil=<?php echo $gelen['id']; ?>"><img src="design/cross.png" alt="" title="Sil" /></a></td>
				</tr>
			<?php } ?>
			</table>
			<br>			
