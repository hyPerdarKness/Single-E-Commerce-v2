...
foreach($ver as $gelen){ $id = $gelen['id']; ?>						
			<?php if($id%2!=0){ echo '<tr>'; }else{ echo '<tr class="bg">'; } ?>	
				    ...
				    <td style="width:100px;" align="center"><a href="yaziedit.php?id=<?php echo $gelen['id']; ?>"><img src="design/edit.png" alt="" title="Düzenle" /></a> &nbsp;&nbsp; <a href="yazilar.php?sil=<?php echo $gelen['id']; ?>"><img src="design/cross.png" alt="" title="Sil" /></a></td>
				</tr>
<?php } echo '</table><br>';
 if($count > $limit) : 
  $x = 2; 
