...
if($sira==""||$title==""||$content==""||$durum==""){ echo '<div class="error msg" style="width:300px;"><b>Bütün alanları doldurmanız gerekmektedir.</b></div>'; }else{

$kayit = $db->prepare("insert into pages set sira=?,title=?,content=?,sefurl=?,durum=?");
$kayit->execute(array($sira, $title, $content, $url, $durum)); 

 echo "<div class='done msg' style='width:200px;'><b>Sayfa Eklendi!</b></div>"; echo '<meta http-equiv="refresh" content="2">'; } } ?>
						<form method="post">
