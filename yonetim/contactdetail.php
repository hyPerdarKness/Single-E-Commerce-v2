...
<div id="main">
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
			...
			<br>
<?php foreach($db->query("select * from contact where id='$id'") as $gelen){ ?>
			<div class="col50">
			
		<p class="t-justify">     
		
						<label><b>Ad Soyad</b></label><br>
						<input type="text" size="40" readonly value="<?php echo $gelen['adsoyad']; ?>" class="input-text" /><br><br>
					
						<label><b>E-Mail</b></label><br>
						<input type="text" size="40" readonly value="<?php echo $gelen['email']; ?>" class="input-text" /><br><br>

						<label><b>Telefon</b></label><br>
						<input type="text" size="40" readonly value="<?php echo $gelen['telefon']; ?>" class="input-text" /><br><br>
			...
			<div class="col50 f-right">
				...
				<p class="t-justify">
						...
						<textarea cols="75" rows="20" readonly class="input-text"><?php echo $gelen['mesaj']; ?></textarea><br><br>								
