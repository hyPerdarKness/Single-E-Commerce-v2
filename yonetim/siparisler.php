...
<div id="main">
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
			...
			<h1>Siparişler</h1>
			<br><br>
<?php if(isset($_GET['sil'])){ $sil = intval($_GET['sil']); $db->query("delete from siparisler where id='$sil'"); 
echo "<div class='warning msg' style='width:200px;'><b>Sipariş silindi.</b></div><br>"; echo '<meta http-equiv="refresh" content="2;URL=siparisler.php">'; } ?>				
			<table>
				<tr>
				    <th>Ürün Adı</th>
				    <th>Sipariş Veren</th>
...
<?php foreach($db->query("select * from siparisler order by id desc") as $gelen){ $id = $gelen['id']; ?>					
			<?php if ($id%2!=0){ echo '<tr>'; }else{ echo '<tr class="bg">'; } ?>	
				    <td style="width:500px;"><?php echo $gelen['urun']; ?></td>
				    <td style="width:500px;"><?php echo $gelen['adsoyad']; ?></td>
				    <td style="width:100px;" align="center"><a href="siparisview.php?id=<?php echo $gelen['id']; ?>"><img src="design/edit.png" alt="" title="Düzenle" /></a> &nbsp;&nbsp; <a href="siparisler.php?sil=<?php echo $gelen['id']; ?>"><img src="design/cross.png" alt="" title="Sil" /></a></td>
				</tr>
			<?php } ?>
			</table>
			<br>			
