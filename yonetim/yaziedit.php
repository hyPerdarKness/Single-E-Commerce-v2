...
if($title==""||$content==""||$resimyolu==""||$keywords==""||$description==""){ echo '<div class="error msg" style="width:300px;">Alanları boş geçemezsiniz!</div>'; }else{

$db->query("UPDATE blog SET title='$title',content='$content',resimyolu='$resimyolu',keywords='$keywords',description='$description',sefurl='$url' where id='$id'");

 echo "<div class='done msg' style='width:200px;'><b>Düzenleme Kaydedildi!</b></div>"; echo '<meta http-equiv="refresh" content="2">'; } }

foreach($db->query("select * from blog where id='$id'") as $gelen){ ?>
						<form method="post">
		...
		<p class="t-justify">   
						...
						<textarea cols="75" rows="2" name="keywords" class="input-text"><?php echo $gelen['keywords']; ?></textarea><br><br>	

						<label><b>Sayfa Tanımlama (Cümle, kelime)</b></label><br>
						<textarea cols="75" rows="2" name="description" class="input-text"><?php echo $gelen['description']; ?></textarea><br><br>								
