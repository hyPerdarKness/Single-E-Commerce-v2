<?php session_start(); define("include",true); include("../config.php"); if(isset($_SESSION['tekurun'])){ ?>
...
<div id="main">
	...
	<div id="tray" class="box">
		...
		<p class="f-left box">
			...
			<span class="f-left" id="switcher">
				<a href="#" rel="1col" class="styleswitch ico-col1" title="one column"><img src="design/switcher-1col.gif" alt="1 Column" /></a>
				<a href="#" rel="2col" class="styleswitch ico-col2" title="two columns"><img src="design/switcher-2col.gif" alt="2 Columns" /></a>
			</span>
	...
	<div id="cols" class="box">
		...
		<div id="content" class="box">
			...
			<h1>Tek Ürün Satış Scripti v2 Yönetim Paneli</h1>
			<br><br>
				<section class="icons">
					<ul>
					...
					<?php $say1 = $db->query("select count(*) from siparisler")->fetchColumn(); if($say1=="0"){ }else{ ?>
						<div style="background-color:red; width:30px; float:right; color:#fff; font-weight:bold; border-radius: 7px; -webkit-border-radius: 7px; -moz-border-radius: 7px;" class="bildirim"><?php echo number_format($say1); ?></div><br><?php } ?>							
								<img src="design/invoice-icon.png" />
								<span>Siparişler</span>
					</a></li>				

              <li><a href="obildirim.php">
					<?php $say2 = $db->query("select count(*) from odemebildirimi")->fetchColumn(); if($say2=="0"){ }else{ ?>			  
						<div style="background-color:red; width:30px; float:right; color:#fff; font-weight:bold; border-radius: 7px; -webkit-border-radius: 7px; -moz-border-radius: 7px;" class="bildirim"><?php echo number_format($say2); ?></div><br><?php } ?>				  
							<img src="design/Info.png" />
							<span>Ödeme Bildirimi</span>
					  </a></li>	

              <li><a href="uyorum.php">
					<?php $say3 = $db->query("select count(*) from yorumlar where onay='0'")->fetchColumn(); if($say3=="0"){ }else{ ?>			  
						<div style="background-color:red; width:30px; float:right; color:#fff; font-weight:bold; border-radius: 7px; -webkit-border-radius: 7px; -moz-border-radius: 7px;" class="bildirim"><?php echo number_format($say3); ?></div><br><?php } ?>				  
							<img src="design/Speech-Bubble.png" />
							<span>Ürün Yorumları</span>
					  </a></li>	

              <li><a href="byorum.php">
					<?php $say4 = $db->query("select count(*) from comments where onay='0'")->fetchColumn(); if($say4=="0"){ }else{ ?>			  
						<div style="background-color:red; width:30px; float:right; color:#fff; font-weight:bold; border-radius: 7px; -webkit-border-radius: 7px; -moz-border-radius: 7px;" class="bildirim"><?php echo number_format($say4); ?></div><br><?php } ?>				  
							<img src="design/Speech-Bubble1.png" />
							<span>Blog Yorumları</span>
					  </a></li>		

                        <li><a href="youcall.php">
					<?php $say5 = $db->query("select count(*) from calling")->fetchColumn(); if($say5=="0"){ }else{ ?>						
						<div style="background-color:red; width:30px; float:right; color:#fff; font-weight:bold; border-radius: 7px; -webkit-border-radius: 7px; -moz-border-radius: 7px;" class="bildirim"><?php echo number_format($say5); ?></div><br><?php } ?>							
					...
					<?php $say6 = $db->query("select count(*) from contact")->fetchColumn(); if($say6=="0"){ }else{ ?>						
						<div style="background-color:red; width:30px; float:right; color:#fff; font-weight:bold; border-radius: 7px; -webkit-border-radius: 7px; -moz-border-radius: 7px;" class="bildirim"><?php echo number_format($say6); ?></div><br><?php } ?>							
